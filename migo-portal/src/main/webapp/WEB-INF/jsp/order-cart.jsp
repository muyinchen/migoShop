...
<div class="w w1 header clearfix">
    <div id="logo"><a href="/src/main/webapp"><img src="/images/migo-logo.gif" alt="咪购商城"></a></div>
</div>
...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverName" value="毛毛"/>
		<input type="hidden" name="orderShipping.receiverMobile" value="15898888888"/>
		...
		<div class="mode-tab-nav">
			<ul>
				<li class="mode-tab-item " id="jd_shipment_item"
					...
					id="jdShip-span-tip" class="m-txt">咪购快递<i
						class='qmark-icon qmark-tip'
						data-tips='由咪购公司负责配送，速度很快，还接受上门刷卡付款服务'></i></span><b></b></li>
			</ul>
		</div>
	</div>
</div>
