...
<div class="cart-inner">
    <div class="cart-thead clearfix">
        ...
        <div class="column t-price">咪购价</div>
        ...
        <div class="ui-ceilinglamp-1" style="width: 988px; height: 49px;"><div class="cart-dibu ui-ceilinglamp-current" style="width: 988px; height: 49px;">
          <div class="control fdibu fdibucurrent">
              ...
              <span class="shopping">
                  ...
                  <a href="/src/main/webapp" target="_blank" clstag="clickcart|keycount|xincart|coudanlink" id="continue">继续购物</a>
              </span>
          </div>
              ...
              <div class="cart-button">
                  ...
                  <span class="combine-btns" style="display:none">
                      ...
                      <span class="fore2 hide" style="display: inline;">
                          <a href="javascript:goToOverseaOrder();" class="checkout-jdInt">去咪购国际结算<b></b></a>
                          <a href="javascript:goToOrder();" class="checkout-jd">去咪购结算<b></b></a>
                      </span>
                  </span>
              </div>
              <div class="total fr">
