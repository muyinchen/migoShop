...
<div id="o-header-2013">
	<div class="w" id="header-2013">
		<div id="logo-2013" class="ld"><a href="/" hidefocus="true" clstag="homepage|keycount|home2013|02a"><b></b><img src="/images/migo-logo.gif" width="270" height="60" alt="咪购"></a></div>
		<!--logo end-->
		<div id="search-2013">
		...
		<div id="my360buy-2013">
			<dl>
				<dt class="ld"><s></s><a href="http://localhost:8084/user/showLogin" clstag="homepage|keycount|home2012|04a">我的咪购</a><b></b></dt>
				<dd>
	...
	<div class="w">
		<div id="nav-2013">
			...
			<div id="treasure" clstag="homepage|keycount|home2013|08a"></div>
				<ul id="navitems-2013">
					<li class="fore1" id="nav-home" clstag="homepage|keycount|home2013|07a"><a href="/src/main/webapp">首页</a></li>
